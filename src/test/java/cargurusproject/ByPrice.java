...
public class ByPrice implements CarGuruConstant {
		...
		public Iterator<Object[]> getTestData() {
			ArrayList<Object[]> dataList =Excelutil.getDataFromExcel("Price",new String[] {"Zipcode","Radius","YearStart","YearEnd","Price Mini","Price Max","Max Milelage","Transmission"});
			return dataList.iterator();
		}

		@Test(dataProvider = "getTestData",priority=2,groups="ByUsedCar")
		public void testByPrice(String zipcode, String radius, String yearStart, String yearEnd, String priceMini,String priceMax,String maxMilelage,String transmission ){
	    ...
	    new Select(driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Years'])[2]/following::select[1]"))).selectByVisibleText(yearStart);
	    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Years'])[2]/following::select[1]")).click();
	    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='to'])[4]/following::select[1]")).click();
	    new Select(driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='to'])[4]/following::select[1]"))).selectByVisibleText(yearEnd);
	    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='to'])[4]/following::select[1]")).click();
	    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Price'])[2]/following::select[1]")).click();
	    new Select(driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Price'])[2]/following::select[1]"))).selectByVisibleText(priceMini);
	    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Price'])[2]/following::select[1]")).click();
	    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='to'])[5]/following::select[1]")).click();
	    new Select(driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='to'])[5]/following::select[1]"))).selectByVisibleText(priceMax);
	    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='to'])[5]/following::select[1]")).click();
	    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Maximum Mileage'])[2]/following::select[1]")).click();
	    new Select(driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Maximum Mileage'])[2]/following::select[1]"))).selectByVisibleText(maxMilelage);
	    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Maximum Mileage'])[2]/following::select[1]")).click();
